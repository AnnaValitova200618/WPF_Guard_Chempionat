...
public partial class User501Context : DbContext
{
    ...
    public virtual DbSet<UserWorker> UserWorkers { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<PersonalVisit>(entity =>
        {
            ...
            entity.Property(e => e.TimeSubdvisionEnd).HasColumnType("datetime");
            entity.Property(e => e.TimeSubdvisionStart).HasColumnType("datetime");

            entity.HasOne(d => d.IdRequestNavigation).WithMany(p => p.PersonalVisits)
                .HasForeignKey(d => d.IdRequest)
                .HasConstraintName("FK_PersonalVisit_Request");
        ...
        modelBuilder.Entity<UserWorker>(entity =>
        {
            entity.ToTable("UserWorker");
            ...
            entity.HasOne(d => d.IdPositionNavigation).WithMany(p => p.UserWorkers)
                .HasForeignKey(d => d.IdPosition)
                .HasConstraintName("FK_UserWorker_Position");

            entity.HasOne(d => d.IdTypeNavigation).WithMany(p => p.UserWorkers)
                .HasForeignKey(d => d.IdType)
                .HasConstraintName("FK_UserWorker_Type");
        });
